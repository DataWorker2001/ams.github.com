...
const HomePage = () => {
    ...
    <div className = "hp1">
      ...
      <br />
      <div style = {{fontWeight: 'bold'}}> This App can be used to manage list of existing 100 albums from this link:  <a href='https://jsonplaceholder.typicode.com/albums' target= 'blank' style ={{textDecoration : 'none'}}>(Click Here to see)</a> and even add new albums and update, delete the list of albums using dummy calls. Once the page is refreshed all changes are lost and until that all are preserved bcz the changes are not made in the server as per requirement. </div>
      <br />
      <ol>
